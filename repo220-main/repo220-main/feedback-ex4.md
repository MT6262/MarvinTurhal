...
| DB-Persistenz                | 3 / 3                              |
| Funktionalität des Frontends | 20,5 / 22                          |
| Usability                    | 3 / 5                              |
| Design-Qualität              | 5 / 5                              |
| Code-Qualität                | 4 / 5                              |
...
- [x] (7,5 / 8 Punkte) View zur Verwaltung von `Assignees`
  - [x] (1 Punkt) View-Elemente für `GET /assignees`
  - [x] (1 Punkt) View-Elemente für `GET /assignees/$id`
  - [.] 1.5 (2 Punkte) View-Elemente für `POST /assignees` // Falscher Hilfstext: @ipvs.uni-stuttgart.de geht auch.
...
- [ ] (1 Punkt) Browser-Console (F12) zeigt keine JS Errors an // Post, error submitting form
...
- [ ] (1 Punkt) Mögliche Anwenderfehler werden minimiert, konkrete Fehler werden kommuniziert (z.B. bei HTTP 400) // Unspezifische Fehlermeldung bei inkorrekter Email-Adresse
...
- [ ] (1 Punkt) Terminologie, Farben und Layout sind konsistent // Fehlermeldung bei Emails: Unterschiedlich bei mit @ und ohne
...
- [ ] (1 Punkt) Code ist hinreichend kommentiert
...
- [ ] (0,5 Punkte) Keine Dummy-Dateien oder irrelevanter Text aus dem Beispiel-Projekt mehr vorhanden // "cats" in api/README.md
